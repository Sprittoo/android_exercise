...
public class Utils {
   ...
   /* Since it's JSON, adding a newline isn't necessary (it won't affect
     ...
     */
//Get the url to the json from buildURL
     ...
     * @return a URL object
     */
    //This is to take the comicNo from user and get the link to xkcd API to get json file
     ...
     */
    //Put getImageURLFromXkcdApi into Bitmap
     ...
     */
    //gets the link for the image itself from the json
